        ...
        <div class="card card-default col-md-6">
            ...
            <div class="card-body">
                <div class="callout callout-danger">
                    <p><strong> Relatar os Cursos Diferentes ministrados. Observar que o mesmo curso ministrado em várias edições/semestres/ano só contará como uma qualificação.</strong></p>
                </div>
            </div>
        </div>
    </div>
