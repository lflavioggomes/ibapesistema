        ...
        <div class="card card-default col-md-6">
            ...
            <div class="card-body">
                <div class="callout callout-danger">
                    <p><strong>Cada ART / RRT - emitida pelo CREA ou CAU - Apresentada equivale a 1 ponto. Apresentar ARTs e RRTs com maior abrangência possível.</strong></p>
                </div>
            </div>
        </div>
    </div>
