    ...
    <div class="col-md-6">
        ...
        <div class="card card-primary">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-app bg-info mt-3" href="{{ url('storage/diploma/'.$result->diploma) }}" target="_blank">
                    <i class="fas  fa-university" style="text-align:center;"></i> Ver Diploma
                    </a>
                @csrf
                    <input type="hidden" name="id" id="id_dado" value="{{$result->id}}">
                    <input type="hidden" name="status_id" id="status_id_admin" value="">
                    <input type="hidden" name="tabela" id="tabela" value="diploma">
                </form>
